...
public class TaskComplete extends Protocol implements Event {

  public TaskComplete(int portNumber, String hostName, String ipAddress) throws IOException {
    super(9, portNumber, hostName, ipAddress);
    this.marshallBytes();
  }

  public TaskComplete(byte[] eventBytes) throws IOException {
    super(eventBytes);
  }
